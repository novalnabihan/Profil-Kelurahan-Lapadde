  ...
  return (
    <section className="py-14 bg-white scroll-mt-[120px]" id="visi-misi">
      <div className="max-w-[1140px] mx-auto px-6">
        <h2 className="text-[28px] font-bold text-[#1a202c] mb-8">Visi & Misi Kelurahan</h2>
        
        <div className="grid md:grid-cols-[0.9fr_1.1fr] gap-6">
          <div className="bg-[#f8f9fa] p-7 rounded-md">
            <h3 className="text-[18px] font-bold text-[#8b9474] uppercase tracking-wide mb-3">
              Visi
            </h3>
            <p className="text-[18px] font-semibold text-[#2d3748] leading-relaxed italic">
              {displayVision}
            </p>
          </div>

          <div className="bg-[#f8f9fa] p-7 rounded-md">
            <h3 className="text-[18px] font-semibold text-[#8b9474] uppercase tracking-wide mb-3">
              Misi
            </h3>
            <ul className="space-y-2.5">
              {displayMission.map((item, index) => (
                <li key={index} className="text-[18px] font-semibold text-[#4a5568] leading-relaxed pl-6 relative">
